...
//var hat = document.getElementById("hat-search");
...
//update to show that the hats are TBD and STRONG
//INNER HTML
...
var bestSellerHeader = document.getElementById
("best-seller")
...
//getAttribute What is the value?

console.log(bottomLink.getAttribute("href"));
console.log(bottomLink.getAttribute("id"));

//setAttribute to change values.

bottomLink.setAttribute("href", "yahoo.com")

var searchArea = document.getElementsByClassName("d-flex")

//searchArea[0].setAttribute("placeholder", "new addition")

var bodyElement = document.getElementsByTagName("body")

bodyElement[0].style.color = "Blue"

bodyElement[0].style["background-color"] = "white";