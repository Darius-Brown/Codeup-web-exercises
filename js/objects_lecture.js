...
alert("Hey, y'all! I own a " + myCar["make"] + " " + myCar.year)
alert("Hey, y'all! I own a " + myCar["color"] + " " + myCar.make + " " + myCar.model)
...
myCar.features = ["Convertible top", "19\" rims", "V8 engine"];
